...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.76\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/06_participant_class_diagrams/participant_document_request_management.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.76\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/06_participant_class_diagrams/participant_loan_request_management.png}
