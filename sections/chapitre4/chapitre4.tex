...
\begin{figure}[H]
\centering
\includegraphics[width=0.56\textwidth,keepaspectratio]{sections/chapitre4/img/other/release2_organization.png}
\caption{Release 2 Organization}
\label{fig:release2_organization}
\end{figure}
% ============================================================
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/02_use_case_diagrams/use_case_sprint3_administrative_requests.png}
\caption{Use Case Diagram -- Sprint 3 Administrative Requests}
\label{fig:use_case_sprint3_administrative_requests}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/02_use_case_diagrams/use_case_hr_administrative_request_processing.png}
\caption{Use Case Diagram -- HR Administrative Request Processing}
\label{fig:use_case_hr_administrative_request_processing}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/03_system_sequence_diagrams/ssd_submit_document_request.png}
\caption{System Sequence Diagram -- Submit Document Request}
\label{fig:ssd_submit_document_request}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/03_system_sequence_diagrams/ssd_process_document_request.png}
\caption{System Sequence Diagram -- Process Document Request}
\label{fig:ssd_process_document_request}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/03_system_sequence_diagrams/ssd_submit_loan_request.png}
\caption{System Sequence Diagram -- Submit Loan Request}
\label{fig:ssd_submit_loan_request}
\end{figure}
\endgroup
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/03_system_sequence_diagrams/ssd_schedule_loan_meeting.png}
\caption{System Sequence Diagram -- Schedule Loan Meeting}
\label{fig:ssd_schedule_loan_meeting}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/03_system_sequence_diagrams/ssd_submit_authorization_request.png}
\caption{System Sequence Diagram -- Submit Authorization Request}
\label{fig:ssd_submit_authorization_request}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/03_system_sequence_diagrams/ssd_hr_administrative_request_decision.png}
\caption{System Sequence Diagram -- HR Administrative Request Decision}
\label{fig:ssd_hr_administrative_request_decision}
\end{figure}
...
\centering
\makebox[\textwidth][c]{%
\includegraphics[width=1.12\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/05_domain_model/domain_model_sprint3_administrative_requests.png}%
}
\caption{Domain Model -- Sprint 3 Administrative Requests}
\label{fig:domain_model_sprint3_administrative_requests}
\end{figure}
\clearpage
...
\noindent{\fontsize{11}{13}\selectfont This diagram shows the participants involved in employee document request submission, validation, status tracking, and request history management.\par}

\vspace{-6pt}

\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/06_participant_class_diagrams/participant_document_request_management.png}
\caption{Participant Class Diagram -- Document Request Management}
\label{fig:participant_document_request_management}
\end{figure}
...
\noindent{\fontsize{11}{13}\selectfont This diagram shows the participants involved in employee loan request submission, validation, eligibility evaluation, status tracking, and request history management.\par}

\vspace{-6pt}

\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/06_participant_class_diagrams/participant_loan_request_management.png}
\caption{Participant Class Diagram -- Loan Request Management}
\label{fig:participant_loan_request_management}
\end{figure}
...
\centering
\makebox[\textwidth][c]{%
\includegraphics[width=1.08\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/06_participant_class_diagrams/participant_authorization_request_management.png}%
}
\caption{Participant Class Diagram -- Authorization Request Management}
\label{fig:participant_authorization_request_management}
\end{figure}
...
\centering
\makebox[\textwidth][c]{%
\includegraphics[width=1.08\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/06_participant_class_diagrams/participant_hr_request_processing.png}%
}
\caption{Participant Class Diagram -- HR Request Processing}
\label{fig:participant_hr_request_processing}
\end{figure}
\clearpage
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/04_state_diagrams/state_document_request_lifecycle.png}
\caption{State Diagram -- Document Request Lifecycle}
\label{fig:state_document_request_lifecycle}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.74\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/04_state_diagrams/state_loan_request_lifecycle.png}
\caption{State Diagram -- Loan Request Lifecycle}
\label{fig:state_loan_request_lifecycle}
\end{figure}
\vspace{-8pt}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.74\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/04_state_diagrams/state_authorization_request_lifecycle.png}
\caption{State Diagram -- Authorization Request Lifecycle}
\label{fig:state_authorization_request_lifecycle}
\end{figure}
\clearpage
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,height=0.90\textheight,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/07_design_class_diagrams/design_document_request_final_file_management.png}
\caption{Design Class Diagram -- Document Request Final File Management}
\label{fig:design_document_request_final_file_management}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,height=0.90\textheight,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/07_design_class_diagrams/design_loan_request_review_management.png}
\caption{Design Class Diagram -- Loan Request Review Management}
\label{fig:design_loan_request_review_management}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/07_design_class_diagrams/design_authorization_request_management.png}
\caption{Design Class Diagram -- Authorization Request Management}
\label{fig:design_authorization_request_management}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/07_design_class_diagrams/design_hr_request_processing.png}
\caption{Design Class Diagram -- HR Request Processing}
\label{fig:design_hr_request_processing}
\end{figure}
\clearpage
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_document_request_hr_decision_frontend.png}
\caption{Conception Sequence Diagram -- Document Request HR Decision Frontend}
\label{fig:sprint3_csd_document_request_hr_decision_frontend}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_document_request_decision_backend.png}
\caption{Conception Sequence Diagram -- Document Request Decision Backend}
\label{fig:sprint3_csd_document_request_decision_backend}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_document_request_final_file_frontend.png}
\caption{Conception Sequence Diagram -- Document Request Final File Frontend}
\label{fig:sprint3_csd_document_request_final_file_frontend}
\end{figure}
\clearpage
\Needspace{6.2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_document_request_final_file_backend.png}
\caption{Conception Sequence Diagram -- Document Request Final File Backend}
\label{fig:sprint3_csd_document_request_final_file_backend}
\end{figure}
\clearpage
\Needspace{6.2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_loan_request_submission_frontend.png}
\caption{Conception Sequence Diagram -- Loan Request Submission Frontend}
\label{fig:sprint3_csd_loan_request_submission_frontend}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_loan_request_submission_backend.png}
\caption{Conception Sequence Diagram -- Loan Request Submission Backend}
\label{fig:sprint3_csd_loan_request_submission_backend}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_loan_request_meeting_frontend.png}
\caption{Conception Sequence Diagram -- Loan Request Meeting Scheduling Frontend}
\label{fig:sprint3_csd_loan_request_meeting_frontend}
\end{figure}
\clearpage
\Needspace{6.2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_loan_request_meeting_backend.png}
\caption{Conception Sequence Diagram -- Loan Meeting Scheduling Backend}
\label{fig:sprint3_csd_loan_request_meeting_backend}
\end{figure}
\clearpage
\Needspace{6.2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_loan_request_decision_frontend.png}
\caption{Conception Sequence Diagram -- Loan Request Decision Frontend}
\label{fig:sprint3_csd_loan_request_decision_frontend}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,height=0.90\textheight,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_loan_request_decision_backend.png}
\caption{Conception Sequence Diagram -- Loan Request Decision Backend}
\label{fig:sprint3_csd_loan_request_decision_backend}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,height=0.90\textheight,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_loan_request_final_file_frontend.png}
\caption{Conception Sequence Diagram -- Loan Final File Delivery Frontend}
\label{fig:sprint3_csd_loan_request_final_file_frontend}
\end{figure}
\clearpage
\Needspace{6.2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_loan_request_final_file_backend.png}
\caption{Conception Sequence Diagram -- Loan Final File Backend}
\label{fig:sprint3_csd_loan_request_final_file_backend}
\end{figure}
\clearpage
\Needspace{6.2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_authorization_request_submission_frontend.png}
\caption{Conception Sequence Diagram -- Authorization Request Submission Frontend}
\label{fig:sprint3_csd_authorization_request_submission_frontend}
\end{figure}
\clearpage
\Needspace{6.2cm}
\SprintThreeScenarioHeading{Conception Sequence Diagram -- Authorizati²on Request Submission Backend}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_authorization_request_submission_backend.png}
\caption{Conception Sequence Diagram -- Authorization Request Submission Backend}
\label{fig:sprint3_csd_authorization_request_submission_backend}
\end{figure}
\clearpage
\Needspace{6.2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_authorization_request_decision_frontend.png}
\caption{Conception Sequence Diagram -- Authorization Request Decision Frontend}
\label{fig:sprint3_csd_authorization_request_decision_frontend}
\end{figure}
\clearpage
\Needspace{6.2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint3_administrative_requests/08_conception_sequence_diagrams/csd_authorization_request_decision_backend.png}
\caption{Conception Sequence Diagram -- Authorization Request Decision Backend}
\label{fig:sprint3_csd_authorization_request_decision_backend}
\end{figure}
\clearpage
...
\begin{figure}[H]
\centering
\includegraphics[width=0.84\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/02_use_case_diagrams/use_case_sprint4_hr_management_calendar.png}
\caption{Use Case Diagram -- Sprint 4 HR Management and Calendar}
\label{fig:use_case_sprint4_hr_management_calendar}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.84\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/02_use_case_diagrams/use_case_sprint4_hr_employee_account_supervision.png}
\caption{Use Case Diagram -- HR Employee and Account Supervision}
\label{fig:use_case_sprint4_hr_employee_account_supervision}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.84\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/02_use_case_diagrams/use_case_sprint4_organization_team_management.png}
\caption{Use Case Diagram -- Organization and Team Management}
\label{fig:use_case_sprint4_organization_team_management}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.84\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/02_use_case_diagrams/use_case_sprint4_calendar_supervision.png}
\caption{Use Case Diagram -- Calendar Supervision}
\label{fig:use_case_sprint4_calendar_supervision}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/03_system_sequence_diagrams/ssd_sprint4_consult_hr_dashboard.png}
\caption{System Sequence Diagram -- Consult HR Dashboard}
\label{fig:ssd_sprint4_consult_hr_dashboard}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/03_system_sequence_diagrams/ssd_sprint4_supervise_employee_account.png}
\caption{System Sequence Diagram -- Supervise Employee Account}
\label{fig:ssd_sprint4_supervise_employee_account}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/03_system_sequence_diagrams/ssd_sprint4_manage_organization_reference_data.png}
\caption{System Sequence Diagram -- Manage Organization Reference Data}
\label{fig:ssd_sprint4_manage_organization_reference_data}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/03_system_sequence_diagrams/ssd_sprint4_manage_team_structure.png}
\caption{System Sequence Diagram -- Manage Team Structure}
\label{fig:ssd_sprint4_manage_team_structure}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/03_system_sequence_diagrams/ssd_sprint4_consult_hr_leave_calendar.png}
\caption{System Sequence Diagram -- Consult HR Leave Calendar}
\label{fig:ssd_sprint4_consult_hr_leave_calendar}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/03_system_sequence_diagrams/ssd_sprint4_consult_team_leave_calendar.png}
\caption{System Sequence Diagram -- Consult Team Leave Calendar}
\label{fig:ssd_sprint4_consult_team_leave_calendar}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/05_domain_model/domain_model_sprint4_hr_management_calendar.png}
\caption{Domain Model -- Sprint 4 HR Management and Calendar}
\label{fig:domain_model_sprint4_hr_management_calendar}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/06_participant_class_diagrams/participant_sprint4_hr_employee_account_supervision.png}
\caption{Participant Class Diagram -- HR Employee and Account Supervision}
\label{fig:participant_sprint4_hr_employee_account_supervision}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/06_participant_class_diagrams/participant_sprint4_organization_reference_data_management.png}
\caption{Participant Class Diagram -- Organization Reference Data Management}
\label{fig:participant_sprint4_organization_reference_data_management}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/06_participant_class_diagrams/participant_sprint4_team_structure_management.png}
\caption{Participant Class Diagram -- Team Structure Management}
\label{fig:participant_sprint4_team_structure_management}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/06_participant_class_diagrams/participant_sprint4_hr_leave_calendar_consultation.png}
\caption{Participant Class Diagram -- HR Leave Calendar Consultation}
\label{fig:participant_sprint4_hr_leave_calendar_consultation}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/06_participant_class_diagrams/participant_sprint4_team_leave_calendar_consultation.png}
\caption{Participant Class Diagram -- Team Leave Calendar Consultation}
\label{fig:participant_sprint4_team_leave_calendar_consultation}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/07_design_class_diagrams/design_sprint4_hr_user_management.png}
\caption{Design Class Diagram -- HR User Management}
\label{fig:design_sprint4_hr_user_management}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/07_design_class_diagrams/design_sprint4_hr_organization_setup.png}
\caption{Design Class Diagram -- HR Organization Setup}
\label{fig:design_sprint4_hr_organization_setup}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/07_design_class_diagrams/design_sprint4_hr_team_management.png}
\caption{Design Class Diagram -- HR Team Management}
\label{fig:design_sprint4_hr_team_management}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/07_design_class_diagrams/design_sprint4_hr_leave_calendar.png}
\caption{Design Class Diagram -- HR Leave Calendar}
\label{fig:design_sprint4_hr_leave_calendar}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/07_design_class_diagrams/design_sprint4_team_leave_calendar.png}
\caption{Design Class Diagram -- Team Leave Calendar}
\label{fig:design_sprint4_team_leave_calendar}
\end{figure}
\clearpage
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_hr_user_management_frontend.png}
\caption{Conception Sequence Diagram -- HR User Management Frontend}
\label{fig:csd_sprint4_hr_user_management_frontend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_hr_user_management_backend.png}
\caption{Conception Sequence Diagram -- HR User Management Backend}
\label{fig:csd_sprint4_hr_user_management_backend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_hr_organization_setup_frontend.png}
\caption{Conception Sequence Diagram -- HR Organization Setup Frontend}
\label{fig:csd_sprint4_hr_organization_setup_frontend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_hr_organization_setup_backend.png}
\caption{Conception Sequence Diagram -- HR Organization Setup Backend}
\label{fig:csd_sprint4_hr_organization_setup_backend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_hr_team_management_frontend.png}
\caption{Conception Sequence Diagram -- HR Team Management Frontend}
\label{fig:csd_sprint4_hr_team_management_frontend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_hr_team_management_backend.png}
\caption{Conception Sequence Diagram -- HR Team Management Backend}
\label{fig:csd_sprint4_hr_team_management_backend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_hr_leave_calendar_frontend.png}
\caption{Conception Sequence Diagram -- HR Leave Calendar Frontend}
\label{fig:csd_sprint4_hr_leave_calendar_frontend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_hr_leave_calendar_backend.png}
\caption{Conception Sequence Diagram -- HR Leave Calendar Backend}
\label{fig:csd_sprint4_hr_leave_calendar_backend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_team_leave_calendar_frontend.png}
\caption{Conception Sequence Diagram -- Team Leave Calendar Frontend}
\label{fig:csd_sprint4_team_leave_calendar_frontend}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,keepaspectratio]{sections/chapitre4/img/sprint4_hr_management_calendar/08_conception_sequence_diagrams/csd_sprint4_team_leave_decision_backend.png}
\caption{Conception Sequence Diagram -- Team Leave Decision Backend}
\label{fig:csd_sprint4_team_leave_decision_backend}
\end{figure}
