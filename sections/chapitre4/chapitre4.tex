...
\indent The Sprint 4 scope covers the HR supervision features implemented in the application: HR dashboard and user management, employee records and employment information, role assignment and account activation or deactivation, team creation and leader assignment, team member management, and leave-availability calendars.
...
\indent HR can maintain the organizational structure by updating employee information, assigning roles, activating or deactivating accounts, creating teams, assigning or changing team leaders, and managing team membership within the allowed scope.

\indent Calendar views expose leave availability according to user role and team context.
...
\indent They emphasize the division between HR operations, team-leader membership management inside the team scope, and calendar consultation by role.
...
\indent It highlights the implemented flows available in the application and prepares the section for the final validated screenshots.
...
\indent It shows how HR centralizes user management, employee information, team setup, role assignment, account activation or deactivation, and leave-availability consultation for employees and teams.
