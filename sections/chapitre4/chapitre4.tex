...
\indent This sprint covers HR management and calendar supervision. It centralizes HR user administration, employee records, team setup, role assignment, account activation or deactivation, and leave-availability views for employees and teams.
...
\indent The Sprint 4 scope covers the HR supervision features implemented in the application: HR dashboard and user management, employee records and employment information, role assignment and account activation or deactivation, team creation and leader assignment, team member assignment, movement, and removal, and leave-availability calendars.

\indent Departments and job titles act as reference data for HR setup, while the request and approval dashboard links remain supporting screens rather than the main Sprint 4 pillar.
...
\indent The main Sprint 4 business concepts are HR users, employee records, account state, roles, departments, job titles, teams, team leaders, team membership, and leave-availability calendars.

\indent HR can maintain the organizational structure by updating employee information, assigning roles, activating or deactivating accounts, creating teams, assigning or changing team leaders, and managing team membership, including assignment, movement, and removal, within the allowed scope.

\indent Team leaders can manage membership only inside their own team, while calendar views expose leave availability according to user role and team context.
...
\indent These diagrams identify the frontend and backend participants involved in HR supervision, employee record maintenance, team administration, and calendar-based leave visibility.

\indent They emphasize the division between HR operations, team-leader membership management restricted to the leader's own team, and calendar consultation by role.
...
\indent These diagrams capture the lifecycle states associated with account activation, team membership changes, and leave-visibility handling in Sprint 4.

\indent They focus on the transitions that HR can enforce and the boundaries that restrict team leaders to their own team.
...
\indent These diagrams document the main design classes that support HR dashboard actions, employee record handling, team administration, and calendar visibility.

\indent They reflect the backend-enforced rules around roles, account state, and membership management.
...
\indent These diagrams outline the internal frontend and backend interactions for HR user management, team operations, and calendar consultation.

\indent They show how frontend requests are validated through the backend for role-aware actions and membership changes.
...
\indent The realization subsection presents the interface screens for HR supervision, employee records, team administration, and calendar visibility.

\indent It highlights the implemented flows available in the application while keeping the screenshot placeholders in place.
...
\indent Sprint 4 delivered the HR management and calendar supervision block.

\indent It shows how HR centralizes user management, employee information, team setup, role assignment, account activation or deactivation, and leave-availability consultation for employees and teams, while request and approval dashboard links remain supporting screens.
...
\textbf{What went well} & \textbf{What needs improvement} \\
\hline
The sprint centralized HR user, team, and calendar supervision in one release block.
&
HR screens still need more validation testing across edge cases.
\\
\hline
Role assignment, activation/deactivation, and employment updates improved HR control over account lifecycle.
&
Team membership operations should be clearer for complex reassignment cases.
\\
\hline
Team and calendar views improved visibility over organization structure and leave availability.
&
Calendar readability should still be reviewed when many leave records are displayed.
\\
\hline
\end{tabular}
