...
\indent The visual sprint journal below presents the selected user stories of Sprint 6 and their completion status in Jira.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/01_jira/sprint6_jira_journal.png}
  \caption*{Visual Sprint Journal -- Sprint 6}
  \phantomsection\label{fig:sprint6_jira_journal}
\end{figure}
...
\setlength{\tabcolsep}{4pt}
\begin{tabular}{|>{\centering\bfseries\arraybackslash}m{1.35cm}|>{\centering\bfseries\arraybackslash}m{3.55cm}|>{\RaggedRight\arraybackslash}m{7.15cm}|>{\centering\arraybackslash}m{1.35cm}|}
\hline
\rowcolor{blue!20}
\textbf{Sprint} & \textbf{Stories} & \centering\textbf{Tasks} & \textbf{Duration} \\
\hline
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\textwidth,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/09_ui_screenshots/sprint6_assistant_platform_qa.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\textwidth,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/09_ui_screenshots/sprint6_personal_leave_draft.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\textwidth,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/09_ui_screenshots/sprint6_team_leader_decision_support.png}
