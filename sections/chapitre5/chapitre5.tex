...
\indent The state diagram below shows the task lifecycle for Sprint 5. A task starts as TODO, moves to IN\_PROGRESS when the assignee picks it up, and ends as DONE.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth,keepaspectratio]{sections/chapitre5/img/sprint5_projects_tasks_reports/04_state_diagrams/state_task_lifecycle.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint5_projects_tasks_reports/08_conception_sequence_diagrams/csd_project_management_frontend.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint5_projects_tasks_reports/08_conception_sequence_diagrams/csd_project_management_backend.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint5_projects_tasks_reports/08_conception_sequence_diagrams/csd_task_assignment_frontend.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint5_projects_tasks_reports/08_conception_sequence_diagrams/csd_task_assignment_backend.png}
...
\hline
Having project and task management scoped to the team made the workflows easier to follow and validate.
&
Task assignment needed careful validation to keep availability checks, team membership, and assignment modes consistent.
\\
\hline
HR managers could filter administrative request data and export it to Excel directly.
&
Future changes to the report section should keep the export limited to administrative request data and not include project or task data unless a dedicated backend source exists.
\\
\hline
\end{tabular}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/08_conception_sequence_diagrams/csd_sprint6_assistant_platform_question_frontend.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/08_conception_sequence_diagrams/csd_sprint6_assistant_platform_question_backend.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/08_conception_sequence_diagrams/csd_sprint6_assistant_request_drafting_frontend.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/08_conception_sequence_diagrams/csd_sprint6_assistant_request_drafting_backend.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/08_conception_sequence_diagrams/csd_sprint6_team_leader_decision_support_frontend.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint6_ai_deployment_stabilization/08_conception_sequence_diagrams/csd_sprint6_team_leader_decision_support_backend.png}
