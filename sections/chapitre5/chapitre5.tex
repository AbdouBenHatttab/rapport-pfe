...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth,keepaspectratio]{sections/chapitre5/img/other/release3_organization.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth,height=0.82\textheight,keepaspectratio]{sections/chapitre5/img/sprint5_projects_tasks_reports/08_conception_sequence_diagrams/csd_task_assignment_backend.png}
